...
{
    /// <summary>
    /// Manipulador HTTP responsável por adicionar o token de autenticação do administrador externo
    /// no cabeçalho Authorization das requisições HTTP.
    /// </summary>
    public class HttpClientAuthorizationAdminExterno : DelegatingHandler
    {
        /// <summary>
        ...
        {
            var token = ValuesConfig.KEYCLOAKAUTHEXTERNO?.access_token;
