...
namespace Locadora_Auto.Infra.ServiceHttp.Servicos.CadastroBase.CadadastroBaseAdmin
{
    public class CadastroBaseAdminService : HttpService, ICadastroBaseAdminService
    {
        private readonly HttpClient _httpClient;
        private readonly ApiConfig _UrlApi;
        private int _CodigoServico;
        public CadastroBaseAdminService(HttpClient httpClient, IOptions<ApiConfig> urlApi)
        {
        ...
        public async Task<(string? mensagem, HttpStatusCode? status, RespostaServiceView? endereco)> CadastrarEndereco(CadastrarEnderecoServiceCommand endereco)
        {
            ...
            {
                return ("Erro ao cadastrar endereço, tente novamente mais tarde.", resposta.StatusCode, null);
            }
