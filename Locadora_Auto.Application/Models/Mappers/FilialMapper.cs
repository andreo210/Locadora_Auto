    ...
    public static class FilialMapper
    {
            ...
            int totalLocacoesMes = 0)
        {
            ...
            return new FilialDto
            {
                ...
                HabilitadaOneWay = filial.HabilitadaOneWay,
                TaxaRetornoOneWay = filial.TaxaRetornoOneWay,
                ToleranciaMinutos = filial.ToleranciaMinutos,
                PercentualHoraExcedente = filial.PercentualHoraExcedente,
                PrecoLitroCombustivel = filial.PrecoLitroCombustivel,
                TaxaServicoAbastecimento = filial.TaxaServicoAbastecimento,
                ValorLimpezaEspecial = filial.ValorLimpezaEspecial,
